...
public class ObjectReturnObrazci {
    ...
    @Expose
    private List<ItemReturnForObrazci> what_zakazal;
    ...
    public List<ItemReturnForObrazci> getWhat_zakazal() {
        return what_zakazal;
    }

    public void setWhat_zakazal(List<ItemReturnForObrazci> what_zakazal) {
