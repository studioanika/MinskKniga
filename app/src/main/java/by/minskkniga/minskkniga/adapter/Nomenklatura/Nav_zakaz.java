...
public class Nav_zakaz extends BaseAdapter {

    private Context _context;
    private ArrayList<Zakaz_product> _objects;

    public Nav_zakaz(Context context, ArrayList<Zakaz_product> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View view = lInflater.inflate(R.layout.adapter_nomenklatura_nav_lv, parent, false);
